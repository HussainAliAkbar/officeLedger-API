...
model.prototype.getDBObject = function getDBObject(object) {
  ...
  let obj = {};
  obj.id = object.id;
  obj.isPaid = object.isPaid;
  obj.businessClientId = object.businessClientId;
  obj.amount = object.amount;
  obj.paymentDate = object.paymentDate;
  obj.additionalDetails = object.additionalDetails;
  obj.paymentMethod = object.paymentMethod;
